...
public:
    ...
    void printRF()
    {
        int a = numerator/NOD(numerator,denominator);
        int b = denominator/NOD(numerator,denominator);
        int c = 0;
        if (numerator < 0)
        {cout << "-";
            c = WHOLE(-a, b);
...
int main()
{
    ...
    cout << "Rational Fraction B is ";
    B.printRF();

    RationalFractions C;
    C = C.RFSum(A,B);
    cout << "Rational Fraction C - sum of A and B equals ";
    C.printRF();

    RationalFractions D;
    D = D.RFDiff(A,B);
    cout << "Rational Fraction D - difference of A and B equals ";
    D.printRF();

    RationalFractions E;
    E = E.RFMult(A,B);
    cout << "Rational Fraction E - multiplication of A and B equals ";
    E.printRF();

    RationalFractions F;
    F = F.RFDiv(A,B);
    cout << "Rational Fraction F - division of A and B equals ";
    F.printRF();

    RationalFractions G;
    G = G.RFUM(A);
    cout << "Rational Fraction G - unitar minus of A and equals ";
    G.printRF();
